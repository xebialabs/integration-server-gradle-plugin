...
abstract class Provider @Inject constructor(project: Project) {
    ...
    @Input
    var keystorePassphrase = project.objects.property<String>().value("test123").get()

    @Input
    var repositoryKeystore = project.objects.property<String>().value("").get()

    @Input
    var storageClass = project.objects.property<String>()
