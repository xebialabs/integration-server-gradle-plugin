...
abstract class Provider @Inject constructor(project: Project) {
    ...
    @Input
    val keystorePassphrase = project.objects.property<String>().value("test123").get()
    ...
    @Input
    val operatorPackageVersion: String = project.objects.property<String>().value("1.0.0").get()
