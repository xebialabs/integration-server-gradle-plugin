...
import ai.digital.integration.server.util.HTTPUtil.Companion.findFreePort
...
class DbUtil {
    ...
    companion object {
        ...
        fun getDatabase(project: Project): Database {
            val databases = project.extensions.getByType(IntegrationServerExtension::class.java).databases
