...
open class ProvideReleaseKubernetesOperatorTask : DefaultTask() {

    companion object {
        const val NAME = "provideReleaseKubernetesOperator"
    }
    ...
    fun launch() {
        ...
        if (operatorHelper.getProvider().operatorBranch.isPresent) {
            ...
            project.logger.lifecycle("Downloading package xl-release-kubernetes-operator version $version")
        } else {
