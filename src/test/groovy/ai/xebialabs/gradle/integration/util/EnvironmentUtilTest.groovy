...
class EnvironmentUtilTest {
    ...
    void getEnvTest() {
        ...
        assertEquals("-Xmx1024m -Djava.util.logging.manager=org.jboss.logmanager.LogManager",
        ...
        assertEquals(1, envMap.size())
        assertEquals(
                "-Xmx1024m -DLOGFILE=deployit.log -Djava.util.logging.manager=org.jboss.logmanager.LogManager",
                envMap.get("DEPLOYIT_SERVER_OPTS"))
    }
}
